...
ERROR_POOL = [
    ...
    _scenario(
        ...
        injection_commands=["ip route replace 10.10.12.2/32 dev lo"],
    ...
    _scenario(
        ...
        injection_commands=["ip route replace 10.10.23.1/32 dev lo"],
    ...
    _scenario(
        ...
        injection_commands=["ip route replace 10.10.14.1/32 dev lo"],
